...
class data_server(object):
    ...
    def data_relaying_loop(self):
        ...
        # ROS setting
        # -----------
        self.pub = rospy.Publisher('XFFTS_SPEC', XFFTS_msg, queue_size=10)
        self.pub2 = rospy.Publisher('XFFTS_PM', XFFTS_pm_msg, queue_size=10)             # PM = Power Meter
        ...
        while True:
            ...
            self.queue.put([XFFTS_SPEC, XFFTS_PM])
